...
- [`addUnderscoreToArgsType`](#addUnderscoreToArgsType): By setting `addUnderscoreToArgsType` to `true`, the generated Args types will have an underscore added to their names. This can be useful to avoid conflicts with other identifiers in your codebase.
